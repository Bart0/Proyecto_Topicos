...
public ConectaBD db;
    ...
    public String insert(Cliente cliente) {
       String result= null;
       String sql="Insert into cliente (idcliente, nombre, apellidos, ciudad, direccion, capital)"
               + " values (?,?,?,?,?,?)";
        try {
            Connection cn= db.getConnection();
            ...
            ps.setString(5, cliente.getDireccion());
             ps.setString(6, cliente.getCapital());
            ps.executeUpdate();            
            ps.close();cn.close();
    ...
    public Cliente get(Integer id) {
        ...
        try {
            ...
            if(rs.next()){
                ...
                cliente.setCapital(rs.getString(6));
            }
            cn.close();
            ps.close();
        } catch (Exception e) {
    ...
    public String update(Cliente cliente) {
        ...
        try {
            ...
            ps.setString(5, cliente.getCapital());
